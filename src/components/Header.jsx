  ...
  return (
    ...
    <div className="header relative bg-[--dark-black] after:content-[''] after:absolute after:top-0 after:left-0 after:h-[100%]  bg-cover bg-center h-screen">
        <div className='absolute z-[1] top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] w-[100%] text-center text-[--white]'>
            ...
            <h1 className='text-[64px] font-semibold'>I'm a Front-end developer.</h1>
            <h4 className='text-[21px] font-extralight mb-4'>based in Peshawar, Pakistan</h4>
            <button className='py-3.5 px-11 mt-2 font-semibold border-2 rounded-[50rem] border-[--dark-blue] text-[--dark-blue]'>Hire me </button>
        </div>
    </div>
    </>
  )
