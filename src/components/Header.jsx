...
const Header = () => {
  return (
    <>
    <div id='home' className="header relative bg-[--dark-black] after:content-[''] after:absolute after:top-0 after:left-0 after:h-[100%]  bg-cover bg-center bg-fixed h-screen">
