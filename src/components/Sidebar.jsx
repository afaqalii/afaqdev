...
const Sidebar = () => {
  ...
  return (
    <div className='fixed w-[100%] flex bg-[--dark-black] items-center justify-between px-3 py-4 lg:flex-col  lg:min-h-full  lg:w-[260px]'>
       ...
       <div>
          <div className="hidden border-solid w-[160px] border-8 border-[#343A40] rounded-[50%]  lg:flex flex-col items-center  mt-6 ">
             <img src={MyPhoto} className='flex rounded-[50%]' alt="My Photo" />
          </div>
